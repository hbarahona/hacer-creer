...
void header(String titulo_activity) { // LISTO, falta detalle
  fill(55);
  noStroke();
  rect(0, 0, width, 45);
  fill(80);
  ...
  //Dibujar el timeline
  noStroke();
  flechanav(570, 7, color(200));
  flechanav(620, 7, color(0, 255, 0));
  flechanav(670, 7, color(200));
  flechanav(720, 7, color(200));
  flechanav(770, 7, color(200));
  flechanav2(820, 7, color(200));
  //Textos
  textAlign(LEFT);
  fill(255);
  textFont(titulo, 24);
